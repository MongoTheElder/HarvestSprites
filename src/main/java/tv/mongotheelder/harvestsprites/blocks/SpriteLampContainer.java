...
public class SpriteLampContainer extends Container {
    private SpriteLampTile tileEntity;
    private PlayerEntity playerEntity;
    private IItemHandler playerInventory;

    public SpriteLampContainer(int windowId, World world, BlockPos pos, PlayerInventory playerInventory, PlayerEntity player) {
        super(Registration.SPRITE_LAMP_CONTAINER.get(), windowId);
        tileEntity = (SpriteLampTile) world.getTileEntity(pos);
